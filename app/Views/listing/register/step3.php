                    ...
                    <div class="card-body">  
                                ...
                                <div class="row my-1">
                                    <div class="col">
                                        <div class="bg-dark rounded text-white px-2 py-2">
                                            Step 2/3 : Register Confirmation
                                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                    <div class="row">
                                        <div class="col my-1">
                                            <label for="notel" class="form-label">Event Name</label>
                                            <input type="text" class="form-control" id="studentid" name="studentid" placeholder="eg:DC97XXX, DM98XXX" value="<?=$event['eventname'];?>" readonly> 
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col my-1">
